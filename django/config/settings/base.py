...
# bitswan_backend/
APPS_DIR = BASE_DIR / "bitswan_backend"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "bitswan_backend.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                # "django.template.context_processors.debug",  # Temporarily disabled to fix URLResolver error
                ...
                "bitswan_backend.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Mike Farad""", "mike.farad@libertyaces.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "bitswan_backend.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "bitswan_backend.users.forms.UserSignupForm"}
