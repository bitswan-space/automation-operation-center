...
def get_var_defaults(
    ...
    defaults = {
        ...
        "DJANGO_SERVER_EMAIL": "",
        "DJANGO_AWS_ACCESS_KEY_ID": os.environ.get("AWS_ACCESS_KEY_ID"),
        "DJANGO_AWS_SECRET_ACCESS_KEY": os.environ.get("AWS_SECRET_ACCESS_KEY"),
        "DJANGO_AWS_STORAGE_BUCKET_NAME": "bitswan-backend",
